...
const mockUserModel = user_model_1.default;
// Setup do app express para testes
const app = (0, express_1.default)();
app.use(express_1.default.json());
// Rotas para teste
app.post('/users', user_controller_1.default.create);
app.get('/users/:id', user_controller_1.default.getUserDataById);
app.get('/users', user_controller_1.default.list);
app.delete('/users/:id', user_controller_1.default.delete);
app.put('/users/:id', user_controller_1.default.update);
app.patch('/users/:id/metrics', user_controller_1.default.updateMetrics);
describe('Users Controller', () => {
    ...
    describe('POST /users', () => {
        ...
        it('deve criar um novo usuário com sucesso', async () => {
            ...
            user_model_1.default.mockImplementation(() => savedUser);
            const response = await (0, supertest_1.default)(app).post('/users').send(validUserData);
    ...
    describe('GET /users/:id', () => {
        it('deve retornar dados do usuário por ID', async () => {
            ...
            const response = await (0, supertest_1.default)(app).get('/users/507f1f77bcf86cd799439011');
        ...
        it('deve retornar campos específicos quando especificados na query', async () => {
            ...
            const response = await (0, supertest_1.default)(app).get('/users/507f1f77bcf86cd799439011?fields=fullName,email');
            expect(response.status).toBe(200);
        ...
        it('deve retornar dados do usuário com ID inválido', async () => {
            ...
            const response = await (0, supertest_1.default)(app).get('/users/invalid-id');
            expect(response.status).toBe(500);
        });
        ...
        it('deve retornar erro 400 quando ID está vazio', async () => {
            ...
            const result = await user_controller_1.default.getUserDataById(req, res);
    ...
    describe('DELETE /users/:id', () => {
        it('deve deletar usuário com sucesso', async () => {
            ...
            const response = await (0, supertest_1.default)(app).delete('/users/507f1f77bcf86cd799439011');
            expect(response.status).toBe(200);
            expect(response.body.id).toBe('507f1f77bcf86cd799439011');
        });
        it('deve retornar erro quando usuário não é encontrado', async () => {
    ...
    describe('PUT /users/:id', () => {
        ...
        it('deve atualizar senha quando fornecida', async () => {
            ...
            expect(response.status).toBe(200);
            expect(mockUserModel.findByIdAndUpdate).toHaveBeenCalledWith('507f1f77bcf86cd799439011', expect.objectContaining({
        ...
        it('deve retornar erro quando email já está em uso', async () => {
            ...
            expect(response.status).toBe(400);
            expect(response.body.message).toBe('O e-mail outro@teste.com já está em uso.');
        });
    ...
    describe('PATCH /users/:id/metrics', () => {
        ...
        it('deve atualizar métricas do usuário com sucesso', async () => {
            ...
            mockUserModel.findById.mockResolvedValue(userInstance);
            const response = await (0, supertest_1.default)(app)
        ...
        it('deve retornar erro 500 quando ocorre erro no servidor', async () => {
            mockUserModel.findById.mockRejectedValue(new Error('Erro no banco de dados'));
            const response = await (0, supertest_1.default)(app)
                .patch('/users/507f1f77bcf86cd799439011/metrics')
                .send(metricsData);
            expect(response.status).toBe(500);
